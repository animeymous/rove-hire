        ...
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              Applied for: <span className="font-medium">{candidate.jobId?.title || 'N/A'}</span>
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <p className="text-sm">{candidate.location || 'Not provided'}</p>
              </div>
              <div>
                <p className="text-xs text-gray-400">Current Role</p>
                <p className="text-sm">{candidate.currentRole || 'Not provided'}</p>
              </div>
              <div>
                <p className="text-xs text-gray-400">Notice Period</p>
                <p className="text-sm">{candidate.noticePeriod || 'Not provided'}</p>
              </div>
              <div>
                <p className="text-xs text-gray-400">Salary Expectation</p>
                <p className="text-sm">{candidate.salaryExpectation || 'Not provided'}</p>
              </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          {timeline.length === 0 ? (
            ...
            <div className="space-y-4">
              {timeline.map((event) => (
                <div key={event._id} className="flex gap-4 pb-4 border-b border-gray-100 last:border-0">
